...
static int find_best_pattern(AtomBlockId blk_id, t_pack_patterns *list_of_pack_patterns, bool *feasible_patterns,
...
static int find_best_pattern(AtomBlockId blk_id, t_pack_patterns *list_of_pack_patterns, bool *feasible_patterns,
	...
	int best_pattern = -1;
	int best_usage = 1000000; //Start with some high usage
	AtomBlockId root_id;
...
t_pack_molecule *alloc_and_load_pack_molecules(
	...
	bool *feasible_patterns = new bool[num_packing_patterns];
