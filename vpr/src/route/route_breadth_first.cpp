...
static void breadth_first_add_to_heap_expand_non_configurable(const float path_cost, const float bend_cost, const int from_node, const int to_node, const int iconn);

static void breadth_first_expand_non_configurable_recurr(const float path_cost, const float bend_cost, t_heap* current, const int from_node, const int to_node, const int iconn, std::set<int>& visited);
